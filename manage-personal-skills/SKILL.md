...
- `/home/codex/skills` is the source of truth for personal skills only.
- `/home/codex/.agents/skills` is the active global install directory for personal and third-party skills.
- `/home/codex/.codex/skills` should contain `.system` plus symlinks to `/home/codex/.agents/skills`.
- Third-party skills stay out of `/home/codex/skills` unless the user explicitly decides to fork one.
...
2. Classify each skill before acting:
   - Personal source skill: belongs in `/home/codex/skills`, README, `.agents`, and `.codex` symlink.
...
3. For personal skill changes:
   - Update `/home/codex/skills/<skill-name>`.
   - Keep `SKILL.md` frontmatter `name` equal to the directory name.
   - Update `/home/codex/skills/README.md` in the same change.
...
4. For third-party installs:
   ...
   - Do not add third-party files to `/home/codex/skills`.
